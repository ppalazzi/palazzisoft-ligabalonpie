<script type="text/javascript"
	...
	<div id="menuWrapper">
		<div class="menu">
			<ul>
				<li><a href="/balonpie/listadoParticipante.adm">Participantes</a>
					<ul>
						<li><a href="/balonpie/nuevoParticipante.adm">Nuevo Participante</a></li>
					</ul>
				</li>				
				...
				<li><a href="/balonpie/listadoEquipo.adm">Equipos</a>
					<ul>
