...
public final class PropertiesValues {
	...
	public static final Long PUNTOS_INICIAL = 0L;
	public static final Long PUNTOS_MAXIMO = 99999999999L;
	
	public static final Integer JUGADOR_CONDICIONES_VALOR_MINIMO = 0;
